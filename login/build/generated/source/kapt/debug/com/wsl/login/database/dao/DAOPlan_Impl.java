  ...
  public List<EPlan> get() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfRepeatEvery)) {
          _tmpRepeat_every = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfStatusAfterRetry)) {
          _tmpStatus_after_retry = null;
        } else {
          _tmpStatus_after_retry = _cursor.getString(_cursorIndexOfStatusAfterRetry);
        }
        final String _tmpTrial_days;
        if (_cursor.isNull(_cursorIndexOfTrialDays)) {
          _tmpTrial_days = null;
        } else {
