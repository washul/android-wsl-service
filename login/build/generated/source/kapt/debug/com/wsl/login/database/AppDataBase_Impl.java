...
public final class AppDataBase_Impl extends AppDataBase {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(DAOCard.class, DAOCard_Impl.getRequiredConverters());
    _typeConvertersMap.put(DAOSubscription.class, DAOSubscription_Impl.getRequiredConverters());
    _typeConvertersMap.put(DAOPlan.class, DAOPlan_Impl.getRequiredConverters());
    _typeConvertersMap.put(DAOConfig.class, DAOConfig_Impl.getRequiredConverters());
