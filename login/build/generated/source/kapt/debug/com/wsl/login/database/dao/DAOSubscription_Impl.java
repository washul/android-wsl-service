  ...
  public List<ESubscription> getSubscriptions() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfChargeDate)) {
          _tmpCharge_date = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfCurrentPeriodNumber)) {
          _tmpCurrent_period_number = null;
        } else {
          _tmpCurrent_period_number = _cursor.getString(_cursorIndexOfCurrentPeriodNumber);
        }
        final String _tmpPeriod_end_date;
        if (_cursor.isNull(_cursorIndexOfPeriodEndDate)) {
          _tmpPeriod_end_date = null;
        } else {
          _tmpPeriod_end_date = _cursor.getString(_cursorIndexOfPeriodEndDate);
        }
        final String _tmpTrial_end_date;
        if (_cursor.isNull(_cursorIndexOfTrialEndDate)) {
          _tmpTrial_end_date = null;
        } else {
