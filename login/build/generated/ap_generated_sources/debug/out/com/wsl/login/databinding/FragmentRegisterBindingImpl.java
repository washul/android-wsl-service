...
public class FragmentRegisterBindingImpl extends FragmentRegisterBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setUser((com.domain.domain.login.models.User) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUser(@Nullable com.domain.domain.login.models.User User) {
        this.mUser = User;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.domain.domain.login.models.User user = mUser;
